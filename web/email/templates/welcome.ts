    ...
    <mj-section padding="0 0 20px 0">
      <mj-column>
        ...
        <mj-text font-size="12px" color="#777777" font-family="Inter, Roboto, Arial" line-height="1.4" align="center">
          You are receiving this email because you signed up for <a href="https://evental.app/support" style="color: #202020; text-decoration:none;">Meetuppp</a>. If you no longer would like to receive these emails, please <a href="https://evental.app/settings/notifications" style="color: #202020; text-decoration:none;">unsubscribe</a>.
        </mj-text>
