    ...
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="16px" color="#777777" font-family="Inter, Roboto, Arial" line-height="1.4">We are happy you have decided to join us. If you have any questions feel free to reach us at <a href="mailto:support@evental.app" style="color: #0066FF; text-decoration:none;">
            support@evental.app
          </a> or <a href="http://localhost:5555/support" style="color: #0066FF; text-decoration:none;">
            create a support ticket</a>.
        </mj-text>

        <mj-text font-size="16px" color="#777777" font-family="Inter, Roboto, Arial" line-height="1.4">To get started using Meetuppp:
          <ul style="margin: 10px auto 10px auto;">
            <li><a style="color: #0066FF; text-decoration:none;" href="http://localhost:5555/events/attending" target="_blank">View your events</a></li>
            <li style="padding-top: 3px"><a style="color: #0066FF; text-decoration:none;" href="http://localhost:5555/settings" target="_blank">Update your profile</a></li>
            <li style="padding-top: 3px"><a style="color: #0066FF; text-decoration:none;" href="http://localhost:5555/events/create" target="_blank">Create an event</a></li>
            <li style="padding-top: 3px"><a style="color: #0066FF; text-decoration:none;" href="http://localhost:5555/guides" target="_blank">Checkout our user guides</a></li>
          </ul>
        </mj-text>
...
export const welcome: GenerateTemplateArgs = {
  ...
  subjectPart: 'Welcome to Meetuppp!',
